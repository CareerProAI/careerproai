  ...
  return (
    <div className="glass-card rounded-2xl p-6 border border-outline-variant/60 shadow-sm">
      ...
      <form onSubmit={handleSave} className="space-y-5 text-xs">
        <div>
          <label className="block text-[11px] font-bold text-on-surface-variant uppercase tracking-wider mb-2">Account Name</label>
          <input
            type="text"
            value={name}
        ...
        <div>
          <label className="block text-[11px] font-bold text-on-surface-variant uppercase tracking-wider mb-2">Account Email</label>
          <input
            type="email"
            value={email}
